...
Future<SimResult> _runSingleMatch(int index) async {
  // Team 1 (P0, P2): Professional
  // Team 2 (P1, P3): Casual
  final Map<int, DifficultyLevel> playerDiffs = {
    0: DifficultyLevel.professional,
    1: DifficultyLevel.casual,
    2: DifficultyLevel.professional,
  ...
  while (!match.isMatchOver) {
    ...
    while (!round.isGameOver) {
      ...
      // Standard constraints for simulation speed
      int timeLimit = activeDiff == DifficultyLevel.professional ? 50 : 20;
  ...
  // Team 0 wins if P0 or P2 is the match winner (Partners mode)
...
void main(List<String> args) async {
  ...
  if (results['help']) {
    print('Casual vs Professional AI Simulator');
    print(parser.usage);
    return;
  }
  ...
  print('=========================================');
  print('   AI MCTS Simulation: Casual vs Pro     ');
  print('=========================================');
  print('Team 1 (P0, P2): PROFESSIONAL (50ms)');
  ...
  // Dispatch work to Isolates (Parallel)
  ...
  print('Team 1 [PRO]:    ${teamWins[0]} wins (${team1Rate.toStringAsFixed(1)}%)');
